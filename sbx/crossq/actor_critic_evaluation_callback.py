...
def get_mc_return_with_entropy_on_reset(bias_eval_env, model, max_ep_len, gamma, n_mc_eval, n_mc_cutoff):
    ...
    while final_mc_list.shape[0] < n_mc_eval:
        ...
        discounted_return_list, discounted_return_with_entropy_list = calc_disc_returns(rewards, alpha, log_probs)
    ...
    q_prediction = jnp.mean(model.predict_critic(final_obs_list, final_act_list), axis=0)[..., 0]
    ...
    def calc_metrics(q_prediction, final_mc_entropy_list):
        ...
        final_mc_entropy_list_normalize_base = jnp.clip(final_mc_entropy_list_normalize_base, a_min=10.0)
